...
MORNING_STAR_UNIVERSE_ID_LIQUID = os.environ.get('MORNING_STAR_UNIVERSE_ID_LIQUID')
MORNING_STAR_UNIVERSE_ID_INDICES = os.environ.get('MORNING_STAR_UNIVERSE_ID_INDICES')

NSE_APP_ID = os.environ.get('NSE_APP_ID')
NSE_PASSWORD = os.environ.get('NSE_PASSWORD')
NSE_BROKER_CODE = os.environ.get('NSE_BROKER_CODE')
