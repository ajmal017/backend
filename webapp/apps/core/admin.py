...
class OrderDetailAdmin(admin.ModelAdmin):
    ...
    list_display = ['user', 'order_id', 'order_status', 'created_at', 'button3', 'button4', 'bank_mandate','button5','button6']
    ...
    def button6(self, obj):
        """
        :param obj: an obj of user Admin
        :return: a button
        """

        return mark_safe('<input type="button" class="order_post" value="Order Post">')
    button6.short_description = 'Order Post'
    button6.allow_tags = True
