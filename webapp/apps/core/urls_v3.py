...
urlpatterns = [
    ...
    url(r'^portfolio/goal/(?P<type>^[a-z]+)/recommended/$', views.GoalRecommendedPortfolio.as_view(), name='goal-recommended-portfolio'),
    ...
    url(r'^funds/goal/(?P<type>^[a-z]+)/get/all/$', views.FundsDividedIntoCategoriesForGoal.as_view(), name='fund-get-all'),
    ...
    url(r'^portfolio/goal/(?P<type>^[a-z]+)/change/$', views.ChangeGoalPortfolio.as_view(), name='change-portfolio'),
