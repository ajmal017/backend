...
HISTORICAL_FUND_DATA_API = 'http://api.morningstar.com/service/mf/Price/MStarID/'
...
FIELDS_FUND_API = [ISIN, MSTAR_ID, FUND_ID, LEGAL_NAME, FUND_STANDARD_NAME, BRANDING_NAME,
                   BROAD_CATEGORY_GROUP, LEGAL_STRUCTURE, CATEGORY_NAME, INCEPTION_DATE, BENCHMARK, CATEGORY_CODE]
...
XSIP_CANCELLATION_DPC_FLAG ="N"
XSIP_CANCELLATION_STATUS = "ACTIVE"
