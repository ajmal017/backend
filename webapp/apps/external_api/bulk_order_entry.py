...
def generate_client_pipe(user_list):
    ...
    def create_user_dict(user_id):
        ...
        bse_dict = OrderedDict([("CLIENT CODE", user.finaskus_id),
                               ...
                               ("CLIENT DEFAULTDP", cons.PHYS),
                               ("CLIENT CDSLDPID", None),
                               ("CLIENT CDSLCLTID", None),
                               ("CLIENT NSDLDPID", None),
                               ("CLIENT NSDLCLTID", None),
                               ("CLIENT BANKNAME", investor_bank.ifsc_code.name),
                               ("CLIENT BANKBRANCH", investor_bank.ifsc_code.bank_branch),
                               ("CLIENT BANKCITY", investor_bank.ifsc_code.city),
                               ("CLIENT ACCTYPE", get_bse_account_type(investor_bank.account_type)),
                               ("CLIENT ACCNO", investor_bank.account_number),
                               ("CLIENT MICRNO", None),
                               ("CLIENT NEFTCODE", investor_bank.ifsc_code.ifsc_code),
