...
def generate_client_pipe(user_list):
    ...
    def create_user_dict(user_id):
        ...
        bse_dict = OrderedDict([("CLIENT CODE", user.finaskus_id),
                               ...
                               ("DEFAULT BANK FLAG2", cons.DEFAULT_BANK_N),
                               ("CLIENT ACCTYPE3", None),
                               ("CLIENT ACCNO3", None),
                               ("CLIENT MICRNO3", None),
                               ("CLIENT NEFTCODE3", None),
                               ("DEFAULT BANK FLAG3", cons.DEFAULT_BANK_N),
                               ("CLIENT ACCTYPE4", None),
                               ("CLIENT ACCNO4", None),
                               ("CLIENT MICRNO4", None),
                               ("CLIENT NEFTCODE4", None),
                               ("DEFAULT BANK FLAG4", cons.DEFAULT_BANK_N),
                               ("CLIENT ACCTYPE5", None),
                               ("CLIENT ACCNO5", None),
                               ("CLIENT MICRNO5", None),
                               ("CLIENT NEFTCODE5", None),
                               ("DEFAULT BANK FLAG5", cons.DEFAULT_BANK_N),
